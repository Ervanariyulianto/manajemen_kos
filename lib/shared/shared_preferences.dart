...
class SharedPrefUtils {
  ...
  static saveAlamat(String alamat) async {
    final SharedPreferences pref = await SharedPreferences.getInstance();
    pref.setString('alamat', alamat);
  }

  static readAlamat() async {
    final SharedPreferences pref = await SharedPreferences.getInstance();
    return pref.getString('alamat');
  }

  static saveTelepon(String telepon) async {
    final SharedPreferences pref = await SharedPreferences.getInstance();
    pref.setString('telepon', telepon);
  }

  static readTeleponuser() async {
    final SharedPreferences pref = await SharedPreferences.getInstance();
